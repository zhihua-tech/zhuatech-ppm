...
@Entity @Table(name="ppm_project_portfolio") public class ProjectPortfolio extends BaseEntity {
    ...
    protected ProjectPortfolio(){} /**
                                    * 商业授权或定制开发请微信添加微信号zhuatech或zhuatech2进行咨询。
                                    */
public ProjectPortfolio(String code,String name,String workshop,int plannedCapacity){this.code=code;this.name=name;this.workshop=workshop;this.plannedCapacity=plannedCapacity;}
    /**
     * 商业授权或定制开发请微信添加微信号zhuatech或zhuatech2进行咨询。
     */
